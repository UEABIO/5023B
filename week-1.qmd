...
1. Work through 5 short data checking tutorials

    - @sec-strings
    - @sec-duplicate
    - @sec-missing
    - @sec-dates
    - @sec-numeric-consistency
    
Read [Missing data types](https://www.ncbi.nlm.nih.gov/books/NBK493614/)
    
2. After each tutorial complete an application checklist to YOUR data

3. Review your checklists and choose **two issues to fix in Week 2**

4. Commit and push your new files to github

## Getting started

1. Make sure your Week 1 work is complete:

* [ ] You have week1/data_questions.txt with at least 5 questions about your data (biological or data validation)

* [ ] Your questions are about YOUR specific dataset

* [ ] Everything is committed and pushed to GitHub


2. Create a new file for your work:

* [ ] Create `week1/tutorial_applications.txt` - this is where you'll complete the checklists

:::{.callout-important}

I am not asking you to run the code from the tutorials on YOUR dataset yet, but just thinking about which code or blocks might be useful for your data

:::

### Checking strings

**Copy this into `week1/tutorial_applications.txt` and complete it:**
...
[ ] I completed the tutorial exercises
...
5. If this tutorial is NOT relevant to my data:
   ...
   [ ] My dates are already in proper format
...
2. Which variables have the most missing data?
   ...
   Variable: ___________ | Percent missing: _____%
   Variable: ___________ | Percent missing: _____%
   Variable: ___________ | Percent missing: _____%
...
3. Missingness types checklist
   ...
   [ ] MCAR (Missing Completely At Random) - appears random/scattered
...
3. Think about consequences:
   ...
   [ ] Flag them for later analysis that accounts for non-independence
   [ ] Other: ___________
...
### Checking numeric and cross-variable consistency
...
2. If YES, which numeric variable looks suspicious?
   ...
   Minimum value: _____  | Is this biologically possible? [ ] Yes [ ] No [ ] Unsure
   Maximum value: _____  | Is this biologically possible? [ ] Yes [ ] No [ ] Unsure
   

   Why do these look wrong?
   [ ] Negative value (impossible for this measurement)
...
5. Choose TWO variables that should be related (e.g., body length and body mass,
   ...
   [ ] Biological constraint (certain combinations impossible)
...
## Final Task: Choose YOUR top two issues

Now that you've completed all 5 tutorials and application checklists, review your work and choose the 2 issues you'll identify and fix in Week 2.

- Create `week1/week2_plan.txt`

```
WEEK 2 CLEANING PLAN
====================
Name: [your name]
Date: [date]

I've completed all 5 tutorials and application checklists.

Looking across all my checklists, these are the 2 most important issues 
to address in Week 2:


ISSUE 1 (Most Important)
-------------------------
Brief description: [What's the problem? 1 sentence]

Which tutorial provides the solution: [Tutorial name/number]

Which variable(s) affected: [Variable name(s)]

Why this is important to fix: [Biological/analytical reason]

What I plan to do: [The technique I'll use, in plain English]



ISSUE 2 (Second Most Important)
--------------------------------
Brief description: [What's the problem? 1 sentence]
...
OTHER ISSUES I NOTICED (but won't fix in Week 2)
-------------------------------------------------
- [Issue 3 - will address later if time]
- [Issue 4 - uncertain how to handle]
- [Issue 5 - decided to leave as-is because...]


QUESTIONS TO DISCUSS IN WEEK 2
-------------------------------
...
- Commit your new files with the message "Created Week 2 cleaning plan"
