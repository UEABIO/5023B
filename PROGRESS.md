...
| 6 | dates.qmd | 15 (exact) | translated | 3 | | 2026-08-26 | lubridate glossary seeded in TRANSLATION.md first (separate commit) since >8 open questions would otherwise result; `plants` bug in Filter dates fixed to `penguins_clean_names` in both R and Python, human-authorised exception to hard rule 1 (OQ-013) |
